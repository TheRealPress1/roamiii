      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-hidden p-0">
        ...
        <ScrollArea className="max-h-[65vh]">
          <div className="p-6 space-y-6">
            ...
            {/* Flying Mode: Single cost card + member avatars */}
            {tripTravelMode === 'flying' && flying.length > 0 && (
              <div className="space-y-3">
                  ...
                  {trip.flight_cost && trip.flight_cost > 0 && (
                    <div className="text-right">
                      <p className="text-sm font-semibold text-foreground">
                        Total: ${(trip.flight_cost * flying.length).toLocaleString()}
                      </p>
                ...
                {/* Single flight cost card */}
                <FlightCostCard
                  trip={trip}
                  flyingMemberCount={flying.length}
                  ...
                  {flying.map((member) => {
                    ...
                    return (
                      <div
                        key={member.id}
                        className={cn(
                          'flex items-center gap-2 px-3 py-1.5 rounded-full bg-blue-50 dark:bg-blue-950 border border-blue-200 dark:border-blue-800',
                          isCurrentUser && 'ring-2 ring-primary/50'
                        )}
                      >
                        <Avatar className="h-6 w-6">
